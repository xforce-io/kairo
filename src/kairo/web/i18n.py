...
CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "glossary.empty": "No entries yet. Add canonical names to ground ASR/digest.",
        "glossary.add_title": "Add entry",
        ...
        "glossary.restep_hint": "Changes apply on next digest/compose. Re-step existing refs to re-ground names.",
        "step.btn": "▶ Step",
    ...
    "zh": {
        ...
        "glossary.empty": "暂无条目。添加规范专名,供纪要/综合 grounding。",
        "glossary.add_title": "添加名词",
        ...
        "glossary.restep_hint": "保存后在下次 digest/compose 生效;已有参考需 re-step 才会重校正专名。",
        "step.btn": "▶ Step",
